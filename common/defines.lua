...
diplomacy = {
	...
	ASKMILACCESS_RELATION_ON_ACCEPT = 15,
	...
	BASE_TRUCE_MONTHS = 0,
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.4, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
